@section('title', "商品分析管理")
@section('content_title', '商品分析列表')
@section('content')
                        ...
                        <table class="table table-bordered">
                            <tr class="active">
                                ...
                                <tr >
                                    ...
                                    @foreach($title as $k=>$v)
                                        <td>
                                        {{isset($value[$k]['time_count_all'])?$value[$k]['time_count_all']:0}}(次)|{{isset($value[$k]['time_count'])?$value[$k]['time_count']:0}}<br>
                                        {{isset($value[$k]['pop_count_all'])?$value[$k]['pop_count_all']:0}}人|{{isset($value[$k]['pop_count'])?$value[$k]['pop_count']:0}}<br>
                                        {{isset($value[$k]['buy_num'])?$value[$k]['buy_num']:0}}个<br>
                                       {{isset($value[$k]['time_count_all'])?round($value[$k]['time_count']/$value[$k]['time_count_all'],4) * 100 ."%":0}}</td>
                                    @endforeach 
