        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <div class="box-body" style="overflow:scroll;width:100%;">
                    <div class="row">
                        <form action="{{ url('game/zfbmoneycount/index') }}" method="get" id="search">
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <button type="button" style="margin-left:5px;" class="btn btn-default col-md-5" onclick="location.href ='{{$base_url}}/game/zfbmoneycount/index';">重置</button>
                            </div>
                        </form>
                    </div>
                </div>
